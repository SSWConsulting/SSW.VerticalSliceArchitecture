...
public static class OpenApiConvenienceExtensions
{
    ...
    public static RouteHandlerBuilder MapGetWithOpenApi<T>(
        ...
        string pattern,
        Delegate handler) => endpoints.MapGet(pattern, handler)
        .ProducesGet<T>();
    ...
    public static RouteHandlerBuilder MapPostWithCreatedOpenApi(
        this IEndpointRouteBuilder endpoints,
        string pattern,
        Delegate handler) => endpoints.MapPost(pattern, handler)
        .ProducesPost()
    ...
    public static RouteHandlerBuilder MapPutWithOpenApi(
        this IEndpointRouteBuilder endpoints,
        string pattern,
        Delegate handler) => endpoints.MapPut(pattern, handler)
        .ProducesPut();
    ...
    public static RouteHandlerBuilder MapDeleteWithOpenApi(
        this IEndpointRouteBuilder endpoints,
        string pattern,
        Delegate handler) => endpoints.MapDelete(pattern, handler)
        .ProducesDelete();
}